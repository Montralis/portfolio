  ...
  <div class="hero">
    ...
    <div class="hero__container" ref="container">
      ...
      <div class="hero__main">
        ...
        Hi, ich bin Leon. Willkommen auf meiner Portfolio Page. Ich bin Software Entwickler und im Themengebiet Cloud
        Computing für sicherheitsrelevante Software spezialisiert. Unten auf der Seite findest du alle relevanten Links
        zu meinen Profilen.
      </h3>
      <h3 v-else-if="currentLanguage === 'eng'" class="hero__text">
        Hi, I'm Leon. Welcome to my portfolio page. I'm a software developer specializing in cloud computing for
        security-related software. At the bottom of the page you will find all relevant links to my profiles.
      </h3>
        <br>
        <div class="language-buttons">
        <h3 @click="setLanguage('de')" :class="{ 'active-lang': currentLanguage === 'de' }">DE</h3>
        <h3>|</h3>
        <h3 @click="setLanguage('eng')" :class="{ 'active-lang': currentLanguage === 'eng' }">ENG</h3>
        </div>
      </div>
      <div class="hero__footer">
        <li class="hero__links">
          ...
          <ul>
            <router-link to="/gallery" class="hero__link">Gallery</router-link>
          </ul>
        </li>
        <div class="hero__copyright">© 2023 Leon Thomanek | Germany</div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    parallax(e) {
      ...
      document.querySelectorAll(".background-img").forEach(function(move) {
